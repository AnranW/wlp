...
Can we then have a relation like $sp.C.G\implies F$? 
...
%   \displaystyle\frac{P\implies\neg\varphi}{\nlp {P\wedge F} {WHILE} {F}} while_0 &
  \displaystyle\frac{\nlp {P} {C'} {\varphi\vee P}}{\nlp {P} {WHILE} {\varphi\vee P}} while_1 &
...
\begin{table}[ht!]\centering
	\begin{tabular}{l;{1pt/1pt}l;{1pt/1pt}l;{1pt/1pt}l}
		...
		$\{C_1\}\square \{C_2\}$ &  &$\wpp.C_1.F\wedge \wpp.C_2.F$& \\\hdashline[1pt/1pt]
		...
		&  $\ \ \ \ \vee(\varphi\wedge wp_d.C'.X)$ & {\color{Maroon} $\ \ \ \  \vee(\varphi\wedge \wpp.C'.X)$} & $ \ \ \ \ \vee(\varphi\wedge wlp_d.C'.X)$\\
		\hline\hline
		\end{tabular}
