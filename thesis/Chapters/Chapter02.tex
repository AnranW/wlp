...
By default, we take \mathl{F(\sigma)} to mean the same as \mathl{F(\sigma)= true} for convenience's sake as shown in \hyperlink{(**)}{Lines (**)}. 
...
\begin{theorem}[Soundness of wlp]{\normalfont\cite{dijkstra90}}
\ \vspace{-1.5mm}
\[
