...
The postcondition in the wlp setting is not only reachable, but also \imptt{guaranteed} upon termination, because we regard the non-deterministic choice as demonic, again favoring to establish Galois connection~\cite{zhang22}. 
