...
We take inspiration from Nipkow and Klein's book~\cite{nipkow2014} and define our big-step semantics in \autoref{tab:big-step}. 
...
~\footnote{$\exists\tau\in\S:P$ is short for $\exists\tau.\tau\in\S:P$}
\]
\end{theorem}
...
\end{theorem}
\todo{finish here and add references. }
% \[wp.C.false = false\]
% \[wlp.C.true = true\]
