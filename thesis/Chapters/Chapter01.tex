...
%~\cite{myreen07}
%~\cite{zhou19}
%~\cite{hooman1994extending}

Likewise, Dijkstra's wp transformer also spawned various scientific work on probabilistic programs, quantum programs, continuous programs, and so much more.
%~\cite{kaminski2016weakest}
%~\cite{boreale20}
%~\cite{liu22}
