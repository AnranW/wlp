...
% One of such methods are \define{Hoare Triples}~\cite{Hoare69} proposed by Tony Hoare in 1969. 
% A Hoare Triple contains three parts: a precondition, a program, and a postcondition. 
% They are written as such: $\{G\}C\{F\}$.
...
% Originally, Hoare Triples only deals with deterministic programs in a top-to-down manner, but nondeterminism can be added in a sensible way~\cite{Dijkstra75}. 
