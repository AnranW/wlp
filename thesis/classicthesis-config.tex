...
\@ifpackageloaded{babel}%
    {%
       ...
       \addto\extrasngerman{%
            ...
            \renewcommand*\thesubfigure{\arabic{subfigure}} % instead of using letters a,b,c use numbers 1,2,3
            \makeatletter
            \renewcommand\p@subfigure{\thefigure.} % add a dot before the subfigure number
            \makeatother
    }{\relax}
\makeatother
