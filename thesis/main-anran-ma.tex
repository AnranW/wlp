...
\cleardoublepage
\ctparttext{In this part, we explain the definition for the formalism used in this thesis, discuss some of the definitions, and demonstrate the semantics of the predicate transformers using graphs, operational and denotational semantics.}
