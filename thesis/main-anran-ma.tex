...
\input{FrontBackmatter/Bookface}
...
\cleardoublepage
\ctparttext{In this part, I explain the definition for the formalism used in this thesis, discuss some of the definitions, and demonstrate the semantics of the predicate transformers using graphs and operational semantics.}
\part{Hoare Triples and Dijkstra's Predicate Transformers}
\input{Chapters/Chapter01}
\input{Chapters/Chapter02} 
\cleardoublepage

\ctparttext{In this part, I discuss the possible scenarios of the inspected implication, identify a distinctive case to study before proceeding with the general setting.}
